...
**學習要點**: React 組件創建、事件處理、window API、鍵盤事件監聯
...
6. **Phase 5 驗證**: Vercel 部署地址可訪問、對話功能正常、移動端適配
